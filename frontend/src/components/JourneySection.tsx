...
const DiscoveryUI = () => (
  <div className="grid grid-cols-2 gap-3 mt-6 px-4 w-full h-full content-start">
    {[
      { title: 'Pachmarhi', desc: 'waterfalls & satpura hills', h: 'h-40', col: 'col-span-2', img: 'bg-[#e1d5c9]', rating: '4.9' },
      { title: 'Varanasi', desc: 'ghats & sacred rituals', h: 'h-32', col: 'col-span-1', img: 'bg-[#d4e0d9]', rating: '4.8' },
      { title: 'Ladakh', desc: 'high passes & valleys', h: 'h-32', col: 'col-span-1', img: 'bg-[#d5dfe5]', rating: '4.9' },
      { title: 'Rishikesh', desc: 'yoga & Ganges river', h: 'h-32', col: 'col-span-2', img: 'bg-[#eeddd9]', rating: '4.7' },
    ].map((item, i) => (
      <motion.div
        key={i}
...
const ItineraryUI = () => (
  <div className="flex flex-col gap-0 mt-4 px-5 w-full h-full">
    ...
    {[
      { time: '09:00 AM', title: 'Sal Forest Trail', loc: 'Bee Falls, Pachmarhi', icon: '🌿' },
      { time: '11:30 AM', title: 'Ancient Rock Caves', loc: 'Pandav Caves, Pachmarhi', icon: '🏔️' },
      { time: '05:30 PM', title: 'Sunset Vistas', loc: 'Dhoopgarh Peak, Pachmarhi', icon: '🌅' },
    ].map((item, i) => (
      <motion.div
        key={i}
  ...
  <div className="flex flex-col gap-4 mt-6 px-4 w-full h-full">
    ...
    >
      <div className="flex justify-between items-center text-xs font-mono-code text-[#8a8582]">
        <div className="flex flex-col"><span className="text-sm font-bold text-black">DEL</span><span className="text-[8px]">New Delhi</span></div>
        ...
        <div className="flex flex-col items-end"><span className="text-sm font-bold text-black">BHO</span><span className="text-[8px]">Bhopal</span></div>
      </div>
      <div className="flex justify-between items-end mt-2">
        <div>
          <div className="flex items-center gap-1.5 text-sm font-medium text-[#2b2728]">
            <div className="w-4 h-4 bg-indigo-900 rounded-sm flex items-center justify-center text-[7px] text-white font-bold">6E</div> IndiGo Airlines
          </div>
          <div className="text-[10px] text-[#8a8582] mt-1 font-mono-code">6E 214 • Seat 14B</div>
        </div>
    ...
    >
      ...
      <div className="flex-1">
        <div className="flex justify-between items-start">
          <h5 className="font-medium text-[#2b2728] text-sm leading-tight">Resort</h5>
          <span className="text-[10px] bg-[#eeddd9] text-[#a47a71] px-1.5 py-0.5 rounded font-bold">4.9★</span>
        </div>
        <div className="text-[10px] text-[#8a8582] mt-1 space-y-0.5">
          ...
          <div className="flex items-center gap-1"><MapPin className="w-2.5 h-2.5" /> Pachmarhi, MP</div>
        </div>
      </div>
    </motion.div>
  </div>
...
const ActivitiesUI = () => (
  <div className="mt-6 px-4 w-full h-full">
    ...
    <div className="flex flex-col gap-3">
      {[
        { title: 'Satpura Jungle Safari', price: '₹1,500', tag: 'Eco-Tour', users: 3, time: '3.5 hrs' },
        { title: 'Pottery & Artisanal Craft', price: '₹800', tag: 'Culture', users: 5, time: '2 hrs' },
        { title: 'Dhoopgarh Sunset Trek', price: '₹1,200', tag: 'Nature', users: 4, time: 'Half day' },
      ].map((act, i) => (
        <motion.div
          key={i}
...
const CoordinationUI = () => (
  <div className="mt-6 px-4 w-full h-full flex flex-col">
    <div className="flex justify-between items-center mb-6 bg-white/60 p-3 rounded-2xl border border-white/50 shadow-sm backdrop-blur-sm">
      <div>
        <h4 className="font-fraunces text-lg text-[#2b2728] leading-tight">Pachmarhi Squad</h4>
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="flex gap-2">
        ...
        <div>
          <div className="bg-white/90 p-3 rounded-2xl rounded-tl-sm shadow-sm border border-black/5 text-xs text-[#4a4542]">
            Should we book the train to Pipariya/Pachmarhi?
          </div>
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex gap-2 flex-row-reverse">
        <div className="flex flex-col items-end">
          <div className="bg-[#74966a] text-white p-3 rounded-2xl rounded-tr-sm shadow-sm text-xs border border-[#74966a]">
            Yes! I'll buy the Vande Bharat tickets now.
          </div>
...
const ConnectedUI = () => (
  <div className="mt-8 px-5 w-full h-full flex flex-col gap-5">
    <div className="text-center space-y-1">
      <h4 className="font-fraunces text-2xl text-[#2b2728]">Pachmarhi 2026</h4>
              ...
              {FEATURES.map((feature, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`cursor-pointer rounded-3xl p-5 transition-all duration-500 overflow-hidden relative border ${isActive
                  ...
                  >
                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-inner transition-colors duration-500 ${isActive ? `bg-gradient-to-br ${feature.color}` : 'bg-black/5'
                          }`}>
                      ...
                      <div className="flex items-center justify-center gap-1.5 mb-6">
                        {FEATURES.map((_, i) => (
                          <button
                            ...
                            className={`h-1.5 rounded-full transition-all duration-300 ${activeIdx === i ? 'w-6 bg-[#2b2728]' : 'w-1.5 bg-[#2b2728]/20'
                              }`}
                          />
                        ))}
                      </div>
